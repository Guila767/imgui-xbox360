...
struct ExampleAssetsBrowser
{
    ...
    bool            AllowBoxSelect                  IMGUI_DEFAULT(true);    // Will set ImGuiMultiSelectFlags_BoxSelect2d
    bool            AllowBoxSelectInsideSelection   IMGUI_DEFAULT(false);   // Will set ImGuiMultiSelectFlags_SelectOnClickAlways
    bool            AllowDragUnselected             IMGUI_DEFAULT(false);   // Will set ImGuiMultiSelectFlags_SelectOnClickRelease
